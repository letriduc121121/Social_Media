    ...
    <div className="min-h-screen flex flex-col  md:flex-row">
      ...
      <div className="flex-1 flex flex-col items-start justify-between p-6 md:p-10 lg:pl-40">
        ...
        <div>
          ...
          <p className="text-xl md:text-3xl text-indigo-950 max-w-72 md:max-w-md">
            connect with global community on chatTee
          </p>
        </div>
        <span className="md:j"></span>
      </div>
